...
export const TASKS: RelocationTask[] = [
  ...
  {
    id: "biometric-siri",
    title: "Book biometric appointment at SIRI",
    description: "Non-EU permit holders must provide fingerprints and facial image to receive their physical residence card.",
    stage: "first-48-hours",
    category: "permits",
    priority: "high",
    status: "not-started",
    documents: ["Permit approval letter", "Passport", "Appointment confirmation"],
    officialLink: "https://nyidanmark.dk/en-GB/Contact-us/Book-an-appointment",
    daysFromArrival: 1,
    appliesTo: ["non-eu"],
    commonMistake: "Not booking promptly — the physical card is needed for CPR registration and cannot be replaced with the digital approval letter.",
    explainer: {
      what: "In-person appointment at SIRI to record fingerprints and facial image for your residence permit card.",
      why: "Without the physical card, Borgerservice may refuse your CPR application.",
      docs: "Permit approval letter, passport.",
      risks: "Delays in booking delay your entire registration chain.",
      next: "Book via nyidanmark.dk/en-GB/Contact-us/Book-an-appointment on day 1 of arrival.",
    },
  },
  ...
  {
    id: "digital-post",
    title: "Activate Digital Post (mandatory government mailbox)",
    description: "All official government letters — tax, immigration, health — arrive here. Mandatory for all CPR holders.",
    stage: "first-week",
    category: "digital",
    priority: "high",
    status: "not-started",
    documents: ["MitID", "CPR number"],
    officialLink: "https://lifeindenmark.borger.dk/apps-and-digital-services/digital-post",
    daysFromArrival: 8,
    blockedBy: "mitid-setup",
    appliesTo: ["everyone"],
    commonMistake: "Not activating promptly — important government letters including tax decisions and health card notifications are sent exclusively via Digital Post.",
    explainer: {
      what: "Denmark's mandatory secure digital mailbox for all government communications.",
      why: "If you miss a letter here, you miss a legal deadline. Unlike e-Boks, Digital Post is not optional.",
      docs: "MitID login, CPR number.",
      risks: "Missed tax notices, missed health card, missed permit renewal reminders.",
      next: "Log in at borger.dk with MitID and activate Digital Post immediately after MitID setup.",
    },
  },
  {
    id: "skat-contact",
  ...
  {
    id: "tastselv-etax",
    title: "Activate e-tax (TastSelv) account",
    description: "SKAT's self-service portal for managing taxes, income information, and tax returns.",
    stage: "first-week",
    category: "tax",
    priority: "medium",
    status: "not-started",
    documents: ["MitID", "CPR number"],
    officialLink: "https://www.tastselv.skat.dk/",
    daysFromArrival: 9,
    blockedBy: "mitid-setup",
    appliesTo: ["everyone"],
    commonMistake: "Waiting until April tax season to log in for the first time — early setup lets you verify deductions are correct throughout the year.",
    explainer: {
      what: "The Danish Tax Agency's online self-service portal.",
      why: "Used for setting up tax cards, viewing deductions, and submitting annual tax returns.",
      docs: "MitID, bank IBAN for refunds.",
      risks: "Unchecked deductions from mid-year arrival often result in over- or under-payment.",
      next: "Log in at tastselv.skat.dk with MitID soon after arrival.",
    },
  },
  ...
  },
  {
    ...
    title: "Register foreign-plated vehicle (within 30 days)",
    description: "If you bring a car, it must be re-registered on Danish plates within 30 days of establishing residence.",
    stage: "first-month",
    category: "essentials",
    priority: "medium",
    status: "not-started",
    documents: ["Foreign vehicle registration certificate", "CPR number", "MitID", "Vehicle inspection certificate", "Proof of insurance"],
    officialLink: "https://motorst.dk/en-us/guides-in-foreign-languages/if-you-bring-a-vehicle-with-foreign-number-plates-to-denmark",
    daysFromArrival: 25,
    appliesTo: ["everyone"],
    commonMistake: "Driving on foreign plates for more than 30 days after Danish residence is established — this is illegal. Registration plates cost DKK 1,180.",
    explainer: {
      what: "Re-registering your foreign vehicle onto Danish number plates.",
      why: "Danish law requires re-registration within 30 days of becoming a resident.",
      docs: "Foreign registration certificate, CPR, MitID for TastSelv vehicle valuation, inspection cert, insurance.",
      risks: "Fines for late registration; registration tax on high-value cars can be substantial.",
      next: "Book a vehicle inspection, then use TastSelv (SKAT) to get a valuation and pay registration tax.",
    },
  },
